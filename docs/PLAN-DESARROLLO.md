...
- Falta: una vía real de alta de clientes/técnicos (hoy `provisionar-cliente`/`provisionar-tecnico` se invocan a mano; se conectarán a la migración de Odoo o a un panel admin más adelante). Recuperar contraseña (self-service) todavía no existe.
